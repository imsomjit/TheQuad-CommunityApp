...
router.get("/:username", apiLimiter, controller.getProfile);

// GET /api/github/:username/repos — public repos (sorted by stars)
router.get("/:username/repos", apiLimiter, controller.getRepos);

// GET /api/github/:username/languages — aggregated language breakdown
router.get("/:username/languages", apiLimiter, controller.getLanguages);

// GET /api/github/:username/activity — recent public events
router.get("/:username/activity", apiLimiter, controller.getActivity);

// GET /api/github/:username/contributions — streak + summary
router.get("/:username/contributions", apiLimiter, controller.getContributions);
