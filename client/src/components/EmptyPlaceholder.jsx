...
export default function EmptyPlaceholder({ icon: Icon, title, description, linkTo, linkText, className = "" }) {
    return (
        <div className={`flex flex-col items-center justify-center p-12 text-center rounded-xl border border-dashed border-rule bg-paper-2/20 ${className}`}>
            ...
            <h3 className="font-sans text-lg font-bold text-ink mb-2 tracking-tight">{title}</h3>
