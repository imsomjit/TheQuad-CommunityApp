    ...
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="space-y-4 animate-in fade-in">
          {[1, 2].map(i => (
            <div key={i} className="border border-rule bg-paper rounded-xl p-5 shadow-sm">
              <div className="flex justify-between items-start mb-3">
                <div className="flex items-center gap-3 w-full">
                  <div className="h-6 w-20 shimmer rounded bg-paper-2" />
                  <div className="h-6 w-32 shimmer rounded bg-paper-2" />
                  <div className="h-4 w-24 shimmer rounded bg-paper-2 ml-auto" />
                </div>
              </div>
              <div className="mb-4">
                <div className="h-4 w-32 shimmer rounded bg-paper-2 mb-2" />
                <div className="space-y-2">
                  <div className="h-16 w-full shimmer rounded bg-paper-2" />
                </div>
              </div>
              <div className="flex items-center justify-between border-t border-rule pt-4">
                <div className="flex items-center gap-4">
                  <div className="h-4 w-32 shimmer rounded bg-paper-2" />
                  <div className="h-4 w-32 shimmer rounded bg-paper-2" />
                  <div className="h-4 w-40 shimmer rounded bg-paper-2" />
                </div>
                <div className="hidden sm:flex items-center gap-2">
                  <div className="h-8 w-24 shimmer rounded bg-paper-2" />
                  <div className="h-8 w-20 shimmer rounded bg-paper-2" />
                </div>
              </div>
            </div>
          ))}
